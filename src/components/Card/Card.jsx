...
export default function Card({ product }) {
  return (
    <Link 
      ...
      className="flex flex-col max-w-[350px] flex-wrap p-[16px] bg-gradient-to-r from-[#0000FF] to-[#FF0000] hover:ring-opacity-40 active:ring-5 active:ring-[#6247eb] hover:ring-4 active:ring-2 active:ring-opacity-90"
    >
